...
def myintro():
    ...
    #Shiv - questioninput is a local varaiable. It cannot be access outside
    #this function
...
def appinputandcost():
    global appetizerinput
    global item_price_app
...
def briceinputandcost():
    global breadandriceinput
    global item_price_brice
...
def mybill():
    ...
    print("                          ")
    print("    -----Fire n' Fusion------")
    #print("PRINT ... questioninput",questioninput)
